...
class _$RegistrationModelImpl implements _RegistrationModel {
  ...
  @override
  String toString() {
    return 'RegistrationModel(email: $email, name: $name, password: $password, confirmPassword: $confirmPassword)';
  }
...
abstract class _RegistrationModel implements RegistrationModel {
  const factory _RegistrationModel(
      ...
      required final String confirmPassword}) = _$RegistrationModelImpl;
